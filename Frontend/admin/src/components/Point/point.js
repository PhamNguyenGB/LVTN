...
import { fetAllPoint } from "../../api/pointAPIs";
...
const Point = () => {
    ...
    const [actionModalPoint, setActionModalPoint] = useState("CREATE");
    const [dataModelPoint, setDataModelPoint] = useState({});
    ...
    const onHideModalPoint = async () => {
        setIsShowModalPoint(false);
        setDataModelPoint({});
        getAllPoint();
    };

    const handleUpdatePoint = (event) => {
        setActionModalPoint("UPDATE");
        setDataModelPoint(event);
        setIsShowModalPoint(true);
    };
    ...
    return (
        <>
                    ...
                    <div id="content-wrapper" className="d-flex flex-column">
                        ...
                        <div id="content">
                            ...
                            <div className="container-fluid mt-5">
                                ...
                                {/* <!-- Page Heading --> */}
                                <h1 className="h3 mb-2 text-gray-800">QUẢN LÍ ĐIỂM THƯỞNG</h1>
                                <div className="row">
                                    <div className="col-10"></div>
                                    <button className="col-2 m-3 btn btn-primary" style={{ width: "200px" }}
                                        onClick={() => {
                                            setIsShowModalPoint(true);
                                            setActionModalPoint("CREATE");
                                        }}
                                    >+Thêm mới điểm thưởng</button>
                                </div>
                                                            ...
                                                            {tableInstance.getRowModel().rows?.map(row => (
                                                                <tr key={row.id}>
                                                                    ...
                                                                    <td style={{ width: "200px" }}>
                                                                        <span>
                                                                            <button className=" btn btn-success ml-5" onClick={() => handleUpdatePoint(row.original)}>
                                                                                <i className="fa fa-solid fa-pencil"></i>
                                                                            </button>
                                                                            <button className=" btn btn-danger ml-3" onClick={() => handleDeletePoint(row.original)}>
            ...
            {isShowModalPoint === true ?
                <>
                    <ModalPoint
                        isShowModalPoint={isShowModalPoint}
                        onHide={onHideModalPoint}
                        action={actionModalPoint}
