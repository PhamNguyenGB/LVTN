...
const Level = () => {
    ...
    const [actionModalLevel, setActionModalLevel] = useState("CREATE");
    const [dataModelLevel, setDataModelLevel] = useState({});
    ...
    const handleUpdateLevel = (level) => {
        setActionModalLevel("UPDATE");
        setDataModelLevel(level);
    ...
    return (
        <>
            ...
            {isShowModalLevel === true ?
                <>
                    <ModalLevel
                        isShowModalLevel={isShowModalLevel}
                        onHide={onHideModalEvent}
                        action={actionModalLevel}
                        dataModelLevel={dataModelLevel}
                    />
                </>
                :
                <></>
